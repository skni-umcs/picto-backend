...
public class RoundServiceTests {
  ...
  public static void setup() {
    ...
    topic = Image.builder().id(1L).path("flower.jpg").build();

    imageSelected = Image.builder().id(2L).path("car.jpg").build();
  ...
  //    @Test
  //    public void givenRoundId_whenGetRoundResult_thenReturnPointsGottenOnCorrect() throws
  // IOException {
  //        // given
  ...
  //    @Test
  //    public void givenRoundId_whenGetRoundResult_thenReturnPointsGottenOnWrong() throws
  // IOException {
  //        // given
